...
{
	// TODO: Once debugger infra is setup (to verify sequence points produced are the same/valid), implement parallelism from WholeAssemblyDecompiler
	public class PortablePdbWriter2
	{
			...
			string currentProgressTitle = "Generating portable PDB...")
		{
			...
			foreach (var sourceFile in sourceFiles)
			{
				...
				collectedSourceFiles[sourceFile.Key] = sourceText;
